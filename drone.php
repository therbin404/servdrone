...
<body>
  ...
  ?>
  <div class="jumbotron a_drone"></div>
  <section class="container">
  <div class="mainTitleContainer">
    <div class="mainTitle">
      <h1>Qu'est-ce qu'un drone ?</h1>
      <div class="line"></div>
    </div>
  </div>
  ...
  <p>
    Il est difficile de retracer l’histoire des drones sans parler de la guerre.
  </p>
  <p>
    En effet, les drones ont été créés pour faire les missions dangereuses ou trop difficiles pour les pilotes et sont souvent utilisés pour des missions de reconnaissances ou de surveillance. 
  </p>
  <p>
  ...
  <p>
    L’arrivée de l’informatique dans les années 1960 a alors permis d’envisager des engins autonomes, capables d’opérer au-dessus d’une zone donnée afin d’y recueillir de précieuses informations. C’est à cette époque que sont apparus en France les premiers drones européens, tel le R20 développé par la société Nord-Aviation et dérivé de l’engin cible CT20 utilisé comme cible pour les avions de chasse ou les missiles. Destiné à la surveillance des champs de bataille, ce drone de reconnaissance R20, opérationnel de 1966 à 1976, est muni d’un programme de vol interne, ce qui le rend insensible aux brouillages.
  </p>
  <p>
    Dans les années 90, les drones étaient même capables de supporter des charges allant jusqu’à 250 kg! A cette époque est aussi mise en place une doctrine “zéro mort”, car en effet, il existe une tension qui touche au droit absolu à la vie et celle du devoir civique de se sacrifier pour la patrie. L’idée est d’éviter les pertes humaines…
  </p>
  <p>
